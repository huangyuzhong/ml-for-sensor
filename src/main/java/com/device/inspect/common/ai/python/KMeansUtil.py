...
def ws_(url,api,paraList):
	...
	#common_input_=[ [host_influx_test ], [ user_influx_test ],[ pwd_influx_test ],[ dbName_influx ],[ table_influx ],[ selcol_influx ],[device_inspect_id],[filter_influx],[n_clustering],]
	common_input_=paraList
	print "common_input ",common_input_
	#testing
	response=ws.req_response(common_input_,url,api)
...
# def TimeSequence_ws(url,api,paraList):
# 	#you can modify input
# 	special_input_=paraList＃[ [host_influx_test ], [ user_influx_test ],[ pwd_influx_test ],[ dbName_influx ],[ table_influx ],[ selcol_influx ],[filter_influx],]
