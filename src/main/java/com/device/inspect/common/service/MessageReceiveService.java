...
public class MessageReceiveService {
    ...
    @Autowired
    public MessageReceiveService(MessageReceiveRepository messageReceiveRepository, UserRepository userRepository,
    ...
    public static class MyMessageListener implements MessageListener {
        ...
        public boolean dealMessage(Message message) {
            ...
            try {
                ...
                messageController.processReceivedReplyMessage(phoneNumber, content);
