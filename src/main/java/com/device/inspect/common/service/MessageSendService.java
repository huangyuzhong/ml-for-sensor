...
public class MessageSendService {
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
                                                User user,String subject,String content) throws Exception {
        // 1. 创建一封邮件
        ...
        mimeMessage.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, user.getEmail(), "UTF-8"));
