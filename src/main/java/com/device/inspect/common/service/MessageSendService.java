...
public class MessageSendService {
    ...
    // 发件人的 邮箱 和 密码
    public static String myEmailAccount = "gao629935@163.com";
    public static String myEmailPassword = "qq996701217";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "996701217@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "996701217@qq.com", "UTF-8"));
